...
const CreatePet = () => {
  ...
  const progressStepsStyle = {
    activeStepIconBorderColor: '#5a189a',
    activeLabelColor: '#5a189a',
    activeStepNumColor: 'white',
    activeStepIconColor: '#5a189a',
    completedStepIconColor: '#5a189a',
    completedProgressBarColor: '#5a189a',
    ...
    <ScrollView style={styles.scroll}>
      <View style={{ flex: 1, marginTop: 50 }}>
        <ProgressSteps {...progressStepsStyle}>
          ...
          >
            <View style={{ alignItems: 'center' }}>
              { images && <Image source={{ uri: images.uri }} style={{ width: 150, height: 150, borderRadius: 100, borderColor: '#000', borderWidth: 2 }} /> }
              <TouchableOpacity style={styles.buttonPhoto} onPress={pickImage}> 
                <Text style={styles.textButton}> Selecionar foto </Text> 
              </TouchableOpacity>
            </View>
          </ProgressStep>
        </ProgressSteps>
